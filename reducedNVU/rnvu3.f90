!---------------------------------------------------------------------- 
!---------------------------------------------------------------------- 
!   rnvu2 :     The Reduced NVU model with initial JPLC=1, no J_K_i!!!
!---------------------------------------------------------------------- 
!---------------------------------------------------------------------- 
...
!      DOUBLE PRECISION Ca_i,AMp,AM,R,Mp,s_i,v_i,w_i,I_i,Ca_j,s_j,v_j,I_j,J_PLC,K_p
      ...
      F(7) = (20E-6) / (1E4) * ( R * (4000.d0) / (0.1d0 * R) - ((66E3) + (AMp + AM)* ((233E3) - (66E3))) * (R - ((20E-6) &
      ...
      F(1) = 1970.d0 * (- ((4.32E-2)) - ( (1.34E-3) * (v_i - (-25.d0))) - 2.d0*((1.29E-3) * (v_i - &
      100.d0) / (1.d0 + exp(-(v_i - (-24.d0)) / 8.5d0))) - ((3.16E-3) * Ca_i / (Ca_i + 0.5d0) * (v_i - (-30.d0))) &
      - (0.d0 * w_i * (v_i - (-94.d0))) - ((6.1E-3) / (1.d0 + exp(-(7.4E-3)*(30.d0*R/(0.1d0 * R) &
